(() => {
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      @media(max-width:720px){.fvc-collections{grid-template-columns:1fr}.fvc-collection[open]{grid-column:auto}.fvc-door{min-height:100px;padding:15px}.fvc-semester>summary,.fvc-research-dossier>summary{grid-template-columns:minmax(0,1fr) auto 16px;padding:12px}.fvc-semester>summary>div,.fvc-research-dossier>summary>div{display:grid;gap:2px}.fvc-semester>summary>div>small,.fvc-research-dossier>summary>div>small{display:none}.fvc-ue-body{padding-left:10px}.fvc-doc{grid-template-columns:20px minmax(0,1fr) 15px}.fvc-doc-main small{white-space:normal}.fvc-formation-head{align-items:center}.fvc-formation-head>strong small{display:none}}
    `;
